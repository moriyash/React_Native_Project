...
const GroupSettingsScreen = ({ route, navigation }) => {
  ...
  // כולם יכולים לערוך פרופיל, רק אדמינים יכולים לערוך הגדרות
  const canEditProfile = isMember; // כל חבר יכול לערוך פרופיל
  const canEditSettings = isCreator || isAdmin; // רק אדמינים יכולים לערוך הגדרות
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      const result = await groupService.updateGroup(groupId, profileUpdateData, imageUri);
